...
def load_and_preprocess_data(file_path):  # 'def' defines a function named 'load_and_preprocess_data'. It takes 'file_path' (a string representing the location of the dataset) as an argument.
    """
    ...
    numeric_columns = df.select_dtypes(include=['float64', 'int64']).columns  # Selects only the numerical columns from the dataset.
